...
public class CoreWorkload extends Workload {
  ...
  public static final String INSERTION_BATCH_SIZE="batchsize";
  public static final String INSERTION_BATCH_SIZE_DEFAULT="1";
  /**
   * Field name prefix.
   */
  ...
  protected static DiscreteGenerator createOperationGenerator(final Properties p) {
    ...
    StringBuilder scenarioNameBuilder = new StringBuilder();
    ...
    final int batchsize = Integer.parseInt(p.getProperty(
        INSERTION_BATCH_SIZE, INSERTION_BATCH_SIZE_DEFAULT));

    final DiscreteGenerator operationchooser = new DiscreteGenerator();
    if (readproportion > 0) {
      operationchooser.addValue(readproportion, "READ");
      scenarioNameBuilder.append((int)(readproportion*100));
      scenarioNameBuilder.append("READ");
    }

    if (updateproportion > 0) {
      operationchooser.addValue(updateproportion, "UPDATE");
      scenarioNameBuilder.append((int)(updateproportion*100));
      scenarioNameBuilder.append("UPDATE");
    }

    if (insertproportion > 0) {
      operationchooser.addValue(insertproportion, "INSERT");
      scenarioNameBuilder.append((int)(insertproportion*100));
      if (batchsize > 1){
        scenarioNameBuilder.append("BATCH");
      }
      scenarioNameBuilder.append("INSERT");
    }

    if (scanproportion > 0) {
      operationchooser.addValue(scanproportion, "SCAN");
      scenarioNameBuilder.append((int)(scanproportion*100));
      scenarioNameBuilder.append("SCAN");
    }

    if (readmodifywriteproportion > 0) {
      operationchooser.addValue(readmodifywriteproportion, "READMODIFYWRITE");
      scenarioNameBuilder.append((int)(readmodifywriteproportion*100));
      scenarioNameBuilder.append("READMODIFYWRITE");
    }
    scenarioName = scenarioNameBuilder.toString();
